...
import { AGRESSION_ANALYZED_PROMPT } from './constants';
import { IAgressionPromptResult } from './interfaces';

@Injectable()
export class AggressionModerator {
  private readonly logger = new Logger(AggressionModerator.name);
